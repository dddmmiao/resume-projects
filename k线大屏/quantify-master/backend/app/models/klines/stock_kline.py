"""
股票K线数据模型 - 专门处理股票K线数据 - 升级SQLModel
"""
...
class StockKlineDataBase(SQLModel):
    """股票K线数据基础模型 - SQLModel字段定义模板"""
    ...
    turnover_rate_f: Optional[Decimal] = Field(default=None, description="换手率(自由流通股)(%)", sa_type=DECIMAL(8, 4), sa_column_kwargs={"comment": "换手率(自由流通股)(%)"})

    # 量比
    volume_ratio: Optional[Decimal] = Field(default=None, description="量比", sa_type=DECIMAL(10, 4), sa_column_kwargs={"comment": "量比"})

    # 估值指标 (daily_basic)
    pe: Optional[Decimal] = Field(default=None, description="市盈率(总市值/净利润)", sa_type=DECIMAL(12, 4), sa_column_kwargs={"comment": "市盈率"})
    pe_ttm: Optional[Decimal] = Field(default=None, description="市盈率TTM", sa_type=DECIMAL(12, 4), sa_column_kwargs={"comment": "市盈率TTM"})
    pb: Optional[Decimal] = Field(default=None, description="市净率(总市值/净资产)", sa_type=DECIMAL(10, 4), sa_column_kwargs={"comment": "市净率"})
    ps: Optional[Decimal] = Field(default=None, description="市销率", sa_type=DECIMAL(10, 4), sa_column_kwargs={"comment": "市销率"})
    ps_ttm: Optional[Decimal] = Field(default=None, description="市销率TTM", sa_type=DECIMAL(10, 4), sa_column_kwargs={"comment": "市销率TTM"})
    dv_ratio: Optional[Decimal] = Field(default=None, description="股息率(%)", sa_type=DECIMAL(8, 4), sa_column_kwargs={"comment": "股息率(%)"})
    dv_ttm: Optional[Decimal] = Field(default=None, description="股息率TTM(%)", sa_type=DECIMAL(8, 4), sa_column_kwargs={"comment": "股息率TTM(%)"})

    # 股本信息 (daily_basic)
    total_share: Optional[Decimal] = Field(default=None, description="总股本(万股)", sa_type=DECIMAL(15, 4), sa_column_kwargs={"comment": "总股本(万股)"})
    float_share: Optional[Decimal] = Field(default=None, description="流通股本(万股)", sa_type=DECIMAL(15, 4), sa_column_kwargs={"comment": "流通股本(万股)"})
    free_share: Optional[Decimal] = Field(default=None, description="自由流通股本(万股)", sa_type=DECIMAL(15, 4), sa_column_kwargs={"comment": "自由流通股本(万股)"})

    # 市值信息 (daily_basic)
    total_mv: Optional[Decimal] = Field(default=None, description="总市值(万元)", sa_type=DECIMAL(18, 4), sa_column_kwargs={"comment": "总市值(万元)"})
    circ_mv: Optional[Decimal] = Field(default=None, description="流通市值(万元)", sa_type=DECIMAL(18, 4), sa_column_kwargs={"comment": "流通市值(万元)"})
    ...
    auction_vol: Optional[Decimal] = Field(default=None, description="集合竞价成交量", sa_type=DECIMAL(15, 2), sa_column_kwargs={"comment": "集合竞价成交量"})
    auction_price: Optional[Decimal] = Field(default=None, description="集合竞价价格", sa_type=DECIMAL(10, 3), sa_column_kwargs={"comment": "集合竞价价格"})
    auction_amount: Optional[Decimal] = Field(default=None, description="集合竞价成交额", sa_type=DECIMAL(15, 2), sa_column_kwargs={"comment": "集合竞价成交额"})
    auction_turnover_rate: Optional[Decimal] = Field(default=None, description="集合竞价换手率", sa_type=DECIMAL(10, 4), sa_column_kwargs={"comment": "集合竞价换手率"})
    auction_volume_ratio: Optional[Decimal] = Field(default=None, description="集合竞价量比", sa_type=DECIMAL(10, 4), sa_column_kwargs={"comment": "集合竞价量比"})
    auction_pct_chg: Optional[Decimal] = Field(default=None, description="集合竞价涨跌幅", sa_type=DECIMAL(10, 4), sa_column_kwargs={"comment": "集合竞价涨跌幅"})
    ...
    def __repr__(self):
        return f"<StockKlineData(ts_code='{self.ts_code}', trade_date='{self.trade_date}', period='{self.period}', close={self.close})>"
