"""
行业指数K线数据访问层 (DAO) - SQLModel优化版本
负责行业指数K线数据的数据库操作，提供高效的分表批量操作
"""
...
class IndustryKlineDAO:
    """行业指数K线数据访问对象"""

    @staticmethod
    def bulk_upsert_industry_kline_data(
...
# 创建全局实例
industry_kline_dao = IndustryKlineDAO()
